...
describe('Batch Scan Sanitization', () => {
  describe('Repository URL Validation', () => {
    it('should accept valid GitHub URLs', () => {
      const validUrls = [
        { input: 'https://github.com/owner/repo', expected: 'https://github.com/owner/repo' },
        { input: 'https://github.com/owner/repo-name', expected: 'https://github.com/owner/repo-name' },
        { input: 'https://github.com/owner/repo_name', expected: 'https://github.com/owner/repo_name' },
        { input: 'https://github.com/owner/repo.git', expected: 'https://github.com/owner/repo' }, // .git is removed
      ];
  ...
  describe('Batch Item Creation Security', () => {
    it('should safely create batch items without XSS', () => {
      const maliciousUrl = 'https://github.com/owner/<script>alert("XSS")</script>';
  ...
  describe('Result Display Security', () => {
    it('should sanitize repository names in result display', () => {
      const result = {
        repoUrl: 'https://github.com/owner/<script>alert("XSS")</script>',
      };
    ...
    it('should sanitize repository URLs in result display', () => {
      const result = {
        repoUrl: 'https://github.com/owner/repo"><script>alert("XSS")</script>',
      };
  ...
  describe('URL Input Processing', () => {
    it('should filter out invalid URLs from textarea input', () => {
      ...
      expect(repos.every(url => url.startsWith('https://github.com/'))).toBe(true);
    });
