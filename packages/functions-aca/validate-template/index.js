...
module.exports = async function (context, req) {
    context.log('Validate template function triggered');
    ...
    try {
        ...
        // Store run info in a database or Azure Table Storage
        // For simplicity, we're just returning the run ID here
