  ...
  if (window.NotificationSystem) {
    ...
    if (!window.Notifications) {
      window.Notifications = {
        ...
        info: (title, message, duration) => window.NotificationSystem.showInfo(title, message, duration),
        success: (title, message, duration) => window.NotificationSystem.showSuccess(title, message, duration),
        warning: (title, message, duration) => window.NotificationSystem.showWarning(title, message, duration),
        error: (title, message, duration) => window.NotificationSystem.showError(title, message, duration),
        
        // Legacy method aliases
        showInfo: (title, message, duration) => window.NotificationSystem.showInfo(title, message, duration),
        showSuccess: (title, message, duration) => window.NotificationSystem.showSuccess(title, message, duration),
        showWarning: (title, message, duration) => window.NotificationSystem.showWarning(title, message, duration),
        showError: (title, message, duration) => window.NotificationSystem.showError(title, message, duration),
        ...
        show: (options) => {
          ...
          switch (type) {
            case 'success':
              return window.NotificationSystem.showSuccess(options.title, options.message, duration);
            case 'warning':
              return window.NotificationSystem.showWarning(options.title, options.message, duration);
            case 'error':
