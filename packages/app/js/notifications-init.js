        ...
        showLoading: (title, message) => {
          ...
          return {
            update: (newTitle, newMessage) =>
              showNotification(newTitle || title, newMessage || message, 'LOADING'),
            success: (successTitle, successMessage) =>
              showNotification(successTitle || 'Success', successMessage || message, 'SUCCESS'),
            error: (errorTitle, errorMessage) =>
              showNotification(errorTitle || 'Error', errorMessage || message, 'ERROR'),
            close: () => {},
          };
        },
        showConfirmation: (title, message, confirmLabel, cancelLabel, callback) => {
