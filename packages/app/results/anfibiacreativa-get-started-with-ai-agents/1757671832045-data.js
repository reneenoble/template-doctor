window.templateData = {
  "compliance": {
    "compliant": [
      ...
      },
      {
        ...
        "details": {
          "compliantCount": 11,
          "issueCount": 44,
          "percentageCompliant": 20,
          "totalChecks": 55
        },
        "id": "compliance-summary",
        "message": "Compliance: 20%"
      }
    ],
    "issues": [
      {
      ...
      {
        "error": "File infra/api.bicep does not contain required resource Microsoft.Resources/resourceGroups",
        "id": "bicep-missing-microsoft.resources/resourcegroups",
        "message": "Missing resource \"Microsoft.Resources/resourceGroups\" in infra/api.bicep",
        "severity": "error"
      },
      {
        "error": "File infra/api.bicep does not contain required resource Microsoft.KeyVault/vaults",
        "id": "bicep-missing-microsoft.keyvault/vaults",
        "message": "Missing resource \"Microsoft.KeyVault/vaults\" in infra/api.bicep",
        "severity": "error"
      },
      {
      ...
      {
        "error": "File infra/core/security/appinsights-access.bicep does not contain required resource Microsoft.Resources/resourceGroups",
        "id": "bicep-missing-microsoft.resources/resourcegroups",
        "message": "Missing resource \"Microsoft.Resources/resourceGroups\" in infra/core/security/appinsights-access.bicep",
        "severity": "error"
      },
      {
        "error": "File infra/core/security/appinsights-access.bicep does not contain required resource Microsoft.KeyVault/vaults",
        "id": "bicep-missing-microsoft.keyvault/vaults",
        "message": "Missing resource \"Microsoft.KeyVault/vaults\" in infra/core/security/appinsights-access.bicep",
        "severity": "error"
      },
      {
    ...
    "summary": "Issues found - Compliance: 20%"
  },
