  ...
  compliance: {
    ...
    compliant: [
      ...
      },
      {
        ...
        message:
          'Good practice: infra/core/ai/cognitiveservices.bicep uses Managed Identity for Azure authentication',
        details: {
      ...
      },
      {
        ...
        category: 'bicepSecurity',
        message:
          'Good practice: infra/core/host/aks-managed-cluster.bicep uses Managed Identity for Azure authentication',
        details: {
      ...
      },
      {
        ...
        category: 'bicepSecurity',
        message:
          'Good practice: infra/core/host/ml-online-endpoint.bicep uses Managed Identity for Azure authentication',
        details: {
