  ...
  compliance: {
    ...
    compliant: [
      ...
      },
      {
        ...
        message:
          'Good practice: infra/resources/ai_foundry.bicep uses Managed Identity for Azure authentication',
        details: {
      ...
      },
      {
        ...
        category: 'bicepSecurity',
        message:
          'Good practice: infra/resources/container_instance.bicep uses Managed Identity for Azure authentication',
        details: {
      ...
      },
      {
        ...
        category: 'bicepSecurity',
        message:
          'Good practice: infra/resources/search_service.bicep uses Managed Identity for Azure authentication',
        details: {
