window.reportData = {
  ...
  ruleSet: 'dod',
  timestamp: '2025-09-24T19:03:03.301Z',
  compliance: {
    issues: [
      {
    ...
    compliant: [
      {
        ...
        details: {
          description:
            'Sample for Azure Function using OpenAI TextCompletion input binding with Java',
        },
      },
      {
        id: 'file-README.md',
      ...
      },
      {
        ...
        category: 'meta',
        message: 'Compliance: 77%',
        details: {
          issueCount: 5,
          compliantCount: 17,
          totalChecks: 22,
          percentageCompliant: 77,
        },
      },
    ],
    percentage: 77,
    summary: 'Issues found - Compliance: 77%',
    categories: {
