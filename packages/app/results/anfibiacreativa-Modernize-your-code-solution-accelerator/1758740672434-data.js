window.reportData = {
  ...
  "ruleSet": "dod",
  "timestamp": "2025-09-24T19:04:32.431Z",
  "compliance": {
    "issues": [
      {
    ...
    "compliant": [
      ...
      {
        "id": "bicep-uses-managed-identity-infra/modules/ai-foundry/project.bicep",
        "category": "bicepSecurity",
        "message": "Good practice: infra/modules/ai-foundry/project.bicep uses Managed Identity for Azure authentication",
        "details": {
          "file": "infra/modules/ai-foundry/project.bicep",
          "authMethod": "ManagedIdentity"
        }
      },
      {
      ...
      },
      {
        ...
        "category": "meta",
        "message": "Compliance: 67%",
        "details": {
          "issueCount": 8,
          "compliantCount": 16,
          "totalChecks": 24,
          "percentageCompliant": 67
        }
      }
    ],
    "percentage": 67,
    "summary": "Issues found - Compliance: 67%",
    "categories": {
