  ...
  compliance: {
    ...
    compliant: [
      ...
      },
      {
        ...
        category: 'bicepSecurity',
        message:
          'Good practice: infra/main_custom.bicep uses Managed Identity for Azure authentication',
        details: {
      ...
      },
      {
        ...
        category: 'bicepSecurity',
        message:
          'Good practice: infra/modules/ai-project.bicep uses Managed Identity for Azure authentication',
        details: {
      ...
      },
      {
        ...
        category: 'bicepSecurity',
        message:
          'Good practice: infra/old/00-older/deploy_ai_foundry.bicep uses Managed Identity for Azure authentication',
        details: {
      ...
      },
      {
        ...
        category: 'bicepSecurity',
        message:
          'Good practice: infra/old/00-older/main.bicep uses Managed Identity for Azure authentication',
        details: {
      ...
      },
      {
        ...
        category: 'bicepSecurity',
        message:
          'Good practice: infra/old/08-2025/main.bicep uses Managed Identity for Azure authentication',
        details: {
      ...
      },
      {
        ...
        category: 'bicepSecurity',
        message:
          'Good practice: infra/old/08-2025/modules/account/modules/project.bicep uses Managed Identity for Azure authentication',
        details: {
