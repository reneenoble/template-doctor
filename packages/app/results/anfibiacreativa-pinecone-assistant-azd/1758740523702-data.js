  ...
  compliance: {
    issues: [
      ...
      },
      {
        ...
        error:
          'Repository should include issue templates to standardize bug reports and feature requests',
      },
      {
    ...
    compliant: [
      {
        ...
        details: {
          description:
            'An Azure Developer template to launch a new Pinecone Assistant using Azure blob storage as the source.',
        },
      },
      {
        id: 'file-README.md',
      ...
      },
      {
        ...
        message:
          'Good practice: infra/containers/container-app.bicep uses Managed Identity for Azure authentication',
        details: {
