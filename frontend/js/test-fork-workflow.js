                            ...
                            [
                                {
                                    ...
                                    callback: async () => {
                                        try {
                                            const updateResult = await window.GitHubClient.updateFork(currentUsername, testRepo);
                        ...
                        [
                            {
                                ...
                                callback: async () => {
                                    try {
                                        ...
                                        const forkResult = await window.GitHubClient.forkRepository(testRepoOwner, testRepo);
