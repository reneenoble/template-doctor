...
if (hasError) {
  ...
  console.log('  - Bicep param: @description(\'Flag to decide whether to create OpenAI role for current user\')');
  console.log('  - Conditional: module openAiRoleUser \'core/security/role.bicep\' = if (createRoleForUser) {');
  console.log('  - Principal type: principalType: \'User\'');
  console.log('  - Docs link: https://github.com/Azure-Samples/azd-template-artifacts/.../trouble-shooting.md');
  console.log('  - Example PR: https://github.com/Azure-Samples/azure-openai-assistant-javascript/pull/18/files');
} else {
