...
const galleryJsonPath = path.resolve(
    __dirname,
    "../packages/app/results/gallery.json",
);
...
console.log(
    "# Copy these URLs for batch scanning with security enabled but without resources results",
);
console.log("# ");
